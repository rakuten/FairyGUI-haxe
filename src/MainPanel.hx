...
class MainPanel
{
    ...
    private var _demoObjects:Map<String,GComponent>;
    ...
    public function new()
    {
        ...
        _demoObjects = new Map<String, GComponent>();
    }
    ...
    {
        var obj:GRichTextField = try cast(evt.currentTarget, GRichTextField)
    ...
    {
        var obj:GComponent = _demoObjects["Depth"];
...
//        obj.getChild("btn1").addEventListener(MouseEvent.CLICK, __click2.bind([MouseEvent.CLICK, obj, startPos]));
    ...
    {
        var obj:GComponent = _demoObjects["Grid"];
    ...
    {
        var obj:fairygui.GComponent = _demoObjects["ProgressBar"];
